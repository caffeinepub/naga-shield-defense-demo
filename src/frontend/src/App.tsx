...
export default function App() {
  ...
  const sidebarIcons = [
    { icon: <Shield size={18} />, label: "Shield", tab: "OVERVIEW" as Tab },
    ...
    { icon: <Eye size={18} />, label: "Threats", tab: "THREAT LOG" as Tab },
    {
      icon: <Radio size={18} />,
      label: "POC",
      tab: "POC OVERVIEW" as Tab,
    },
    { icon: <Lock size={18} />, label: "Vault", tab: "OVERVIEW" as Tab },
    { icon: <Activity size={18} />, label: "Score", tab: "OVERVIEW" as Tab },
  ];
      ...
      >
        <div className="flex items-center gap-3 flex-shrink-0">
          ...
          <div>
            ...
            >
              LAYER 2 SECURITY DEFENSE SYSTEM
            </div>
          </div>
        </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p
                    ...
                    style={{ fontSize: "11px" }}
                  >
                    ICP Layer 2 Enforcement — Proof of Concept Submission
                  </p>
                </div>
